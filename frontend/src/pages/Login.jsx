    ...
    const handleSubmit = async (e) => {
        ...
        try{
            ...
            if (result?.data) {
                ...
                showErrorAlert('Error de inicio de sesión', result.message);
            } else {
                showErrorAlert('Error de inicio de sesión', 'Respuesta inesperada del servidor');
            }
        } catch(error){
            showErrorAlert('Error de inicio de sesión', error.response?.data?.message || 'Ocurrió un error inesperado' );
        }
